var CustomImportScript = (() => {
  ...
  // tools/importer/import-about-corporate.js
  var import_about_corporate_exports = {};
  __export(import_about_corporate_exports, {
    default: () => import_about_corporate_default
  });
  ...
  var PAGE_TEMPLATE = {
    ...
    description: "Corporate about page with hero, brand messaging, mixed media content sections, stats and proof points, and resource links",
    urls: ["https://www.cisco.com/site/us/en/about/why-cisco/index.html"],
    blocks: [
  ...
  var import_about_corporate_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_about_corporate_exports);
})();
